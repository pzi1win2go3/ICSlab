...
0000000000400e20 <func4>:
  400e20:	53                   	push   %rbx                 // edx = 14, esi = 0
  400e21:	89 d1                	mov    %edx,%ecx            // ecx = 14
  400e23:	29 f2                	sub    %esi,%edx            // edx = 14
  400e25:	89 d0                	mov    %edx,%eax            // eax = 14
  400e27:	c1 e8 1f             	shr    $0x1f,%eax           // eax >> 31 => eax = 0           -7
  400e2a:	01 d0                	add    %edx,%eax            // eax += edx => eax = 14         -8
  400e2c:	d1 f8                	sar    %eax                 // eax >> 1 => eax = 7            -9
  400e2e:	8d 1c 30             	lea    (%rax,%rsi,1),%ebx   // ebx = esi + eax => ebx = 7     -10
  400e31:	39 fb                	cmp    %edi,%ebx            // cmp 1st input and 7            -11
  ---------------------------------------------------------------------------------------------------------
  400e33:	7e 0c                	jle    400e41 <func4+0x21>  // if 7 <= input, then go to e41  -12
                                                            // if 7 > input, then go on       
  400e35:	8d 53 ff             	lea    -0x1(%rbx),%edx      // edx = ebx - 1                  -13
  400e38:	e8 e3 ff ff ff       	callq  400e20 <func4>       // go to e20                      -14
  ---------------------------------------------------------------------------------------------------------
  400e3d:	01 c3                	add    %eax,%ebx                                              -15
  400e3f:	eb 10                	jmp    400e51 <func4+0x31>                                    -16
  400e41:	39 fb                	cmp    %edi,%ebx            // ebx >= 1st input ?             -17
  400e43:	7d 0c                	jge    400e51 <func4+0x31>                                    -18
  400e45:	8d 73 01             	lea    0x1(%rbx),%esi       // esi = rbx + 1                  -19
  400e48:	89 ca                	mov    %ecx,%edx            // edx = 14                       -20  
  400e4a:	e8 d1 ff ff ff       	callq  400e20 <func4>       // go back to the start
  400e4f:	01 c3                	add    %eax,%ebx            // ebx = eax + ebx
  400e51:	89 d8                	mov    %ebx,%eax            // return ebx
  400e53:	5b                   	pop    %rbx
  400e54:	c3                   	retq   
